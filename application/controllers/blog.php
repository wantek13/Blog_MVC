...
{
   require '../application/managers/articles_model.php';
   $articles = getArticles($bdd);
   require '../application/views/home.phtml';
}
...
function createAction($bdd)
{
   ...
   require '../application/views/create.phtml';
}
...
function loginAction($bdd)
{
   if($_SERVER['REQUEST_METHOD'] === 'POST')
   {
      ...
      {
         require '../application/managers/utilisateurs_model.php';
   ...
   require '../application/views/login.phtml';
}
...
function registerAction($bdd)
{
   ...
   require '../application/views/register.phtml';
}